...
if (NOT __GLOG_INCLUDED)
  ...
  if (GLOG_FOUND)
    ...
    #list(APPEND CMAKE_CXX_FLAGS GLOG_EXTRA_COMPILER_FLAGS)
    set(CMAKE_CXX_FLAGS "${CMAKE_CXX_FLAGS} ${GLOG_EXTRA_COMPILER_FLAGS}")
    set(GLOG_CXX_FLAGS ${CMAKE_CXX_FLAGS})
    message(STATUS "GLOG_CXX_FLAGS: ${GLOG_CXX_FLAGS}")
    ...
    ExternalProject_Add(glog
      ...
      CONFIGURE_COMMAND env "CXXFLAGS=${GLOG_CXX_FLAGS}" ${glog_PREFIX}/src/glog/configure --prefix=${glog_INSTALL} --enable-shared=no --enable-static=yes --with-gflags=${GFLAGS_LIBRARY_DIRS}/..
      LOG_DOWNLOAD 1
      LOG_CONFIGURE 1
      LOG_INSTALL 1
      )
