...
typedef mybool(parseGetCharFunction)(struct _parse *, char *);

typedef mybool(parseUnGetCharFunction)(struct _parse *, char);

typedef void(parseDisposeFunction)(struct _parse *);
