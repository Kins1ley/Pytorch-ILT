...
#define errorReportLocationWith(ex, file, line, args) \
    (errorInitPrint(), printFormat(errorGlobalPrint, ((char *)"error in %s, line %d: ", file, line)), printFormat(errorGlobalPrint, ((char *)args)), exit(ex))

#define errorReportExt(args) errorReportExtWith(1, args)
#define errorReportExtWith(ex, args) \
    (errorInitPrint(), printFormat(errorGlobalPrint, ("error: ")), printFormat(errorGlobalPrint, args), exit(ex))
